    ...
    <div id="footer-wrapper">
        ...
        <div class="grid col-620 copyright">
            <?php esc_attr_e('&copy;', 'responsive'); ?> <?php _e(date('Y')); ?><a href="<?php echo home_url('/') ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>">
                <?php bloginfo('name'); ?>
            </a>&nbsp;&nbsp;|&nbsp;&nbsp;Providing Massage and Wellness Services in South Minneapolis, MN
        ...
        <div class="grid col-300 fit powered">
         ...
         ?>
            ...
            <a href="<?php echo esc_url(__('http://www.wahldev.com/','Wahldev')); ?>" title="Website by Wahldev">
                    Website by Wahldev</a>
        </div><!-- end .powered -->
